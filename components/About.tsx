      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Bagian Teks & Tombol di Sebelah Kanan Avatar */}
          ...
          <div>
            ...
            <p className="text-slate-600">I am an Informatics student. backend developer.</p>
          </div>

          {/* 3. BAGIAN INTERESTS */}
          <div className="w-full border-t border-slate-200/60 pt-4 mt-2">
